<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="<?= base_url('admin/cheat-sheets/category/' . (int)$category['id'] . '/upload') ?>" class="btn btn-primary btn-sm">Upload</a>
    </div>
</div>
...
<?php else: ?>
    <div class="card">
        <div class="card-body text-center py-5">
            ...
            <p class="text-muted mb-3">Upload the first cheat sheet for this category.</p>
            <a href="<?= base_url('admin/cheat-sheets/category/' . (int)$category['id'] . '/upload') ?>" class="btn btn-primary">Upload</a>
        </div>
    </div>
<?php endif; ?>
