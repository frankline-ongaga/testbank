<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Documents - <?= esc($subcategory['name']) ?></h5>
        <div class="d-flex gap-2">
            <a href="<?= base_url('admin/study-bank-pdfs/'.$category['id'].'/subcategories') ?>" class="btn btn-secondary btn-sm">Back</a>
            <a href="<?= base_url('admin/study-bank-pdfs/subcategory/'.$subcategory['id'].'/upload') ?>" class="btn btn-primary btn-sm">Upload Document</a>
        </div>
    </div>
    <div class="card-body">
        ...
        <div class="text-center text-muted py-5">
            ...
            <a href="<?= base_url('admin/study-bank-pdfs/subcategory/'.$subcategory['id'].'/upload') ?>" class="btn btn-primary">
