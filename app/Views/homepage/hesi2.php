        ...
        <section class="page_title_banner">
            <div class="container">
                <div class="content">
                    <div class="title">
                        <h3>Worried you won’t pass your HESI A2 test? </h3>
                        <p>The most similar questions to actual NCLEX exam.</p>
  ...
  <div class="container">
    <div class="row g-4">
      <!-- Card 1 -->
      <div class="col-lg-6">
          <h6 class="color-primary mb-8"></h6>
          <h2 class="mb-16">You Have Nothing Lose</h2>

          <p>Our team of experts have crafted a course that has figured out everything you need to know for the test so you don’t have to. </p><br>
          <p> Build your test-taking confidence with targeted quizzes that help you get a feel for the types of questions you’ll see on test day. </p>
      ...
      <div class="col-lg-6">
        <div class="card p-4 shadow-sm h-100">
          <h6 class="color-primary mb-8"></h6>
          <h2 class="mb-16">ATI TEAS 7</h2>
         <div class="block mb-16">
                           
                            <ul class="unstyled rules">
                                <li class="mb-16"><i class="fal fa-check"></i>
                                    <p>Well detailed study guides</p>
                                </li>
                                <li class="mb-16"><i class="fal fa-check"></i>
                                    <p>Performance tracking</p>
                                </li>
                                <li class="mb-16"><i class="fal fa-check"></i>
                                    <p>Questions and well-detailed explanation </p>
                                </li>
                                ...
                                <li class="mb-16"><i class="fal fa-check"></i>
                                 ...
                                 <li class="mb-16"><i class="fal fa-check"></i>
                                    <p>1250 questions with 99% accuracy prediction of real exam </p>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="block mb-16">
                            ...
                            <ul class="unstyled rules">
                             ...
                             <a href="contact.html" class="educate-btn"><span class="educate-btn__curve"></span>Get in
                            Touch</a>
                        </div>
                       
                    </div>
                    <div class="col-md-5">
                        <img src="assets/media/team/team_detail.png" alt="" class="br-15 shadow mb-32 mb-lg-0">
                    </div>
