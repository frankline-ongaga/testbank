...
<head>
    ...
    <title><?= isset($title) ? esc($title) : 'Instructor Dashboard' ?> - NCLEX Prep Course</title>
    ...
    <header class="admin-header">
        <div class="admin-header-left">
            ...
            <div class="admin-brand">
                ...
                <span class="admin-brand-name">Instructor Portal</span>
            </div>
        </div>
        <div class="admin-header-right">
            ...
            <div class="admin-user-menu">
                <?php
                    ...
                    $displayName = $userName ?: 'Instructor';
